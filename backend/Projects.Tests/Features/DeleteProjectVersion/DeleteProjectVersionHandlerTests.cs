...
namespace Projects.Tests.Features.DeleteProjectVersion
{
    public class DeleteProjectVersionHandlerTests
    {
        ...
        private static DeleteProjectVersionHandler CreateHandler(ProjectDbContext context, IMediator mediator)
        {
            return new DeleteProjectVersionHandler(mediator, context);
        } 
